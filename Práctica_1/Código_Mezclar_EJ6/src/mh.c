...
#pragma omp for schedule(static)
	...
	// Ordenar la población usando mergeSort en paralelo
#pragma omp parallel
	{
#pragma omp single
...
#pragma omp single
	...
	// Ordena el array del mejor individuo
...
void mergeSort(Individuo **poblacion, int izq, int der)
{
	...
	int med = (izq + der) / 2;
	int threshold = 100; // umbral para crear tareas
